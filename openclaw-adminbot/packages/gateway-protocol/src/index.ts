...
import {
  ...
  type OperatorSecretRequestParams,
  OperatorSecretRequestParamsSchema,
  type OperatorSecretResolveParams,
  OperatorSecretResolveParamsSchema,
...
export const validateOperatorSecretRequestParams = lazyCompile<OperatorSecretRequestParams>(
  OperatorSecretRequestParamsSchema,
);
export const validateOperatorSecretResolveParams = lazyCompile<OperatorSecretResolveParams>(
  OperatorSecretResolveParamsSchema,
);
