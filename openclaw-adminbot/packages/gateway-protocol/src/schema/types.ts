...
export type OperatorSecretRequestParams = SchemaType<"OperatorSecretRequestParams">;
export type OperatorSecretResolveParams = SchemaType<"OperatorSecretResolveParams">;
