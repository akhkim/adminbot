...
| `src/gateway/server-methods/chat/chat.ts`                    | 2,492 (was 5,104)   | The `chat.send` handler is a single ~1,900-line arrow function holding dispatch, delivery, transcript and abort state in one scope.                                                                                 |
