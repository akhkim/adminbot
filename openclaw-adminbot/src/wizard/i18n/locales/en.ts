...
export const en = {
  ...
  wizard: {
    ...
    adminbot: {
      bindSlack: "Route unmatched Slack conversations to the AdminBot agent?",
      configured: "AdminBot is configured with a dedicated minimal-tool agent.",
      defaultDryRun: "Default AdminBot proposals and executions to dry-run mode?",
      enable: "Set up AdminBot for approval-gated admin workflows?",
      intro:
        "AdminBot uses OpenClaw for conversation and a local loopback service for policy, approvals, execution, and audit logging.",
      invalidEnv: "Enter an environment variable name without whitespace.",
      invalidUrl: "Enter a valid URL.",
      required: "This value is required.",
      serviceBaseUrl: "AdminBot service URL",
      serviceTokenEnv: "AdminBot service token environment variable",
      slackAlreadyConfigured: "Slack routing already points at AdminBot.",
      slackConflict:
        "Slack routing was not changed because an existing binding is owned by: {agents}.",
      slackConfigured: "Unmatched Slack conversations will route to AdminBot.",
      slackSkipped: "Slack routing was left unchanged.",
      title: "AdminBot",
      workspace: "AdminBot workspace directory",
    },
    model: {
    ...
    finalize: {
      ...
      customDashboardOpenHint:
        "Open the Dashboard URL above from a browser that can reach the Gateway WebSocket URL.",
