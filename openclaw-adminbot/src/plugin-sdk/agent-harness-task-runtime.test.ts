...
import { deliverSubagentAnnouncement } from "../agents/subagents/subagent-announce-delivery.js";
...
vi.mock("../agents/subagents/subagent-announce-delivery.js", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../agents/subagents/subagent-announce-delivery.js")>();
  return {
    ...actual,
