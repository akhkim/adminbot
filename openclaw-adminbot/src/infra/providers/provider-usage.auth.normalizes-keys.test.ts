...
vi.mock("../../agents/cli-runner/cli-credentials.js", () => ({
...
let clearRuntimeAuthProfileStoreSnapshots: typeof import("../../agents/auth/auth-profiles.js").clearRuntimeAuthProfileStoreSnapshots;
...
describe("resolveProviderAuths key normalization", () => {
  ...
  beforeAll(async () => {
    ...
    ({ clearRuntimeAuthProfileStoreSnapshots } =
      await import("../../agents/auth/auth-profiles.js"));
