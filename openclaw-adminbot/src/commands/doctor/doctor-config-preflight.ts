...
import type { ConfigFileSnapshot, LegacyConfigIssue } from "../../config/types/types.js";
import { isTruthyEnvValue } from "../../infra/env.js";
import { resolveHomeDir } from "../../utils.js";
import { noteIncludeConfinementWarning } from "./doctor-config-analysis.js";
import { findDoctorLegacyConfigIssues } from "./shared/legacy-config-issues.js";

type DoctorStateMigrationsModule = typeof import("./doctor-state-migrations.js");
type DoctorCronModule = typeof import("./cron/index.js");
...
function loadDoctorCron(): Promise<DoctorCronModule> {
  doctorCronPromise ??= import("./cron/index.js");
