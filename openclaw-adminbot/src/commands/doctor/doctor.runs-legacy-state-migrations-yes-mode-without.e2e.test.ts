...
vi.mock("../../plugins/providers/providers.runtime.js", async () => {
  const actual = await vi.importActual<
    typeof import("../../plugins/providers/providers.runtime.js")
  >("../../plugins/providers/providers.runtime.js");
  return {
    ...actual,
...
let healthCommand: typeof import("../maintenance/health.js").healthCommand;
...
describe("doctor command", () => {
  beforeEach(async () => {
    ...
    ({ healthCommand } = await import("../maintenance/health.js"));
    vi.clearAllMocks();
