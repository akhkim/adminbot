...
vi.mock("./repair-sequencing.js", async () => {
  const actual =
    await vi.importActual<typeof import("./repair-sequencing.js")>("./repair-sequencing.js");
  return {
    ...actual,
...
vi.mock("../../config/legacy/legacy.js", () => {
  type LegacyRule = {
    path: string[];
    message: string;
...
vi.mock("./shared/legacy-config-migrate.js", () => ({
...
vi.mock("./shared/plugin-tool-allowlist-warnings.js", () => ({
...
vi.mock("./shared/context-engine-host-compat.js", () => ({
...
vi.mock("./shared/legacy-config-issues.js", async () => {
  const {
    collectRelevantDoctorPluginIds,
    listPluginDoctorLegacyConfigRules,
  }: typeof import("../../plugins/doctor-contract-registry.js") =
    await import("../../plugins/doctor-contract-registry.js");
  const { findLegacyConfigIssues }: typeof import("../../config/legacy/legacy.js") =
    await import("../../config/legacy/legacy.js");
  return {
...
vi.mock("./shared/preview-warnings.js", () => {
  function asRecord(value: unknown): Record<string, unknown> | null {
    return value && typeof value === "object" && !Array.isArray(value)
      ? (value as Record<string, unknown>)
      : null;
...
describe("doctor config flow", () => {
  beforeAll(async () => {
    await Promise.all([
      import("../../config/plugin/plugin-auto-enable.js"),
      import("./repair-sequencing.js"),
      import("./shared/channel-doctor.js"),
      import("./shared/legacy-config-issues.js"),
      import("./shared/plugin-tool-allowlist-warnings.js"),
      import("./shared/preview-warnings.js"),
    ]);
  });
