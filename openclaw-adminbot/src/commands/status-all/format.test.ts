      ...
      resolveStatusDashboardUrl({
        cfg: {
          gateway: {
            ...
            controlUi: { launchUrl: "https://dash.example.com/admin" },
          },
        },
      }),
    ).toBe("https://dash.example.com/admin?gatewayUrl=ws%3A%2F%2F10.0.0.5%3A18789");
    expect(
      resolveStatusDashboardUrl({
        cfg: {
          gateway: {
            controlUi: {
              enabled: false,
              launchUrl: "https://dash.example.com/admin",
            },
          },
        },
      }),
    ).toBe("https://dash.example.com/admin?gatewayUrl=ws%3A%2F%2F127.0.0.1%3A18789");
    expect(
      resolveStatusDashboardUrl({
        cfg: {
          gateway: {
