...
let loadModelRegistry: typeof import("./list.registry.js").loadModelRegistry;
let toModelRow: typeof import("./list.model-row.js").toModelRow;
...
vi.mock("../../plugins/providers/provider-runtime.js", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../../plugins/providers/provider-runtime.js")>();
  return {
    ...actual,
...
vi.mock("./list.provider-catalog.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./list.provider-catalog.js")>();
  return {
    ...actual,
...
describe("models list/status", () => {
  ...
  beforeAll(async () => {
    ...
    ({ loadModelRegistry } = await import("./list.registry.js"));
    ({ toModelRow } = await import("./list.model-row.js"));
  });
