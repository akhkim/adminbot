...
} from "../../config/gateway/gateway-dispatch-config.js";
...
import { normalizeMessageChannel } from "../../shared/message-channel-normalize.js";
...
type AgentSessionModule = typeof import("./session.js");
type RuntimeConfigModule = typeof import("../../config/io/io.js");
...
let replyPayloadModulePromise:
  ...
  | undefined;
const defaultAgentSessionModuleLoader: AgentSessionModuleLoader = () => import("./session.js");
...
async function loadRuntimeConfig(): Promise<OpenClawConfig> {
  runtimeConfigModulePromise ??= import("../../config/io/io.js");
