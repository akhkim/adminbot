...
import { ConfigMutationConflictError } from "../../config/mutate/mutate.js";
...
import { formatHealthCheckFailure } from "../maintenance/health-format.js";
import { healthCommand } from "../maintenance/health.js";
import { setupChannels } from "../onboard/onboard-channels.js";
import {
  applyWizardMetadata,
  DEFAULT_WORKSPACE,
...
import { promptRemoteGatewayConfig } from "../onboard/onboard-remote.js";
import { setupSkills } from "../onboard/onboard-skills.js";
import type { OnboardMode } from "../onboard/onboard-types.js";
...
async function promptWebToolsConfig(
  ...
  const { isCodexNativeWebSearchRelevant } =
    await import("../../agents/transport/codex-native-web-search.js");
  ...
  if (enableSearch) {
    ...
    if (configureManagedProvider) {
      const { resolveSearchProviderOptions, setupSearch } =
        await import("../onboard/onboard-search.js");
