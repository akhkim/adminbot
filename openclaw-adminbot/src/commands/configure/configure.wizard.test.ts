...
vi.mock("../maintenance/health.js", () => ({
  healthCommand: vi.fn(),
}));

vi.mock("../maintenance/health-format.js", () => ({
...
vi.mock("../onboard/onboard-remote.js", () => ({
  promptRemoteGatewayConfig: mocks.promptRemoteGatewayConfig,
}));

vi.mock("../onboard/onboard-skills.js", () => ({
  setupSkills: vi.fn(),
}));

vi.mock("../onboard/onboard-channels.js", () => ({
  setupChannels: mocks.setupChannels,
}));

vi.mock("../onboard/onboard-search.js", () => ({
...
vi.mock("../../agents/transport/codex-native-web-search.js", () => ({
  isCodexNativeWebSearchRelevant: mocks.isCodexNativeWebSearchRelevant,
}));

vi.mock("../../config/mutate/mutate.js", async () => {
  const actual = await vi.importActual<typeof import("../../config/mutate/mutate.js")>(
    "../../config/mutate/mutate.js",
  );
  return {
    ...actual,
