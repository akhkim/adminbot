...
import { testing as providerAuthChoiceTesting } from "../../plugins/providers/provider-auth-choice.js";
...
type ResolveDeprecatedProviderInstallCatalogEntry =
  typeof import("../../plugins/providers/provider-install-catalog.js").resolveDeprecatedProviderInstallCatalogEntry;
...
vi.mock("../../agents/agent-scope.js", () => ({
  ...
  // Required by src/agents/models/model-runtime-policy.ts, which is transitively
