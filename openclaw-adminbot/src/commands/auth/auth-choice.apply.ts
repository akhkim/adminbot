...
import { applyAuthChoiceLoadedPluginProvider } from "../../plugins/providers/provider-auth-choice.js";
import type { AuthChoice } from "../onboard/onboard-types.js";
...
async function formatDeprecatedProviderChoiceError(
  ...
  const { resolveManifestDeprecatedProviderAuthChoice } =
    await import("../../plugins/providers/provider-auth-choices.js");
  ...
  const { resolveDeprecatedProviderInstallCatalogEntry } =
    await import("../../plugins/providers/provider-install-catalog.js");
