...
let channelsAddCommand: typeof import("./add.js").channelsAddCommand;
...
vi.mock("../../cli/plugins/plugins-registry-refresh.js", () => registryRefreshMocks);

vi.mock("../../cli/plugins/plugins-install-record-commit.js", () => pluginInstallRecordCommitMocks);

vi.mock("../../wizard/clack-prompter.js", () => ({
  createClackPrompter: () => channelWizardMocks.prompter,
}));

vi.mock("../onboard/onboard-channels.js", async () => {
  const actual = await vi.importActual<typeof import("../onboard/onboard-channels.js")>(
    "../onboard/onboard-channels.js",
  );
  return {
    ...actual,
...
describe("channelsAddCommand", () => {
  beforeAll(async () => {
    ({ channelsAddCommand } = await import("./add.js"));
  });
