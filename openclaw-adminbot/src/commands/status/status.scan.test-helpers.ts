...
export async function loadStatusScanModuleForTest(
  ...
  vi.doMock("../../cli/program/command-config-resolution.js", () => ({
  ...
  vi.doMock("../../config/paths/paths.js", async () => {
    const actual = await vi.importActual<typeof import("../../config/paths/paths.js")>(
      "../../config/paths/paths.js",
    );
    return {
      ...actual,
  ...
  vi.doMock("../../cli/plugins/plugin-registry.js", () =>
    createStatusPluginRegistryModuleMock(mocks),
  );
  vi.doMock("../../plugins/config/status.js", () => createStatusPluginStatusModuleMock(mocks));
