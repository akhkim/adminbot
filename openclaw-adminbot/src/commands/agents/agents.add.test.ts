...
vi.mock("../../cli/plugins/plugins-install-record-commit.js", async () => ({
  ...(await vi.importActual<typeof import("../../cli/plugins/plugins-install-record-commit.js")>(
    "../../cli/plugins/plugins-install-record-commit.js",
  )),
