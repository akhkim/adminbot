...
import type { DmConfig, MentionPatternsPolicyConfig, ProviderCommandsConfig } from "./messages.js";
import type { GroupToolPolicyBySenderConfig, GroupToolPolicyConfig } from "./tools.js";
...
export type SlackExecApprovalConfig = {
  ...
  enabled?: import("./approvals.js").NativeExecApprovalEnableMode;
