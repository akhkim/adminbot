...
import { SilentReplyPolicyConfigSchema } from "./agent-defaults.js";
import { ToolsSchema } from "./agent-runtime.js";
import { AgentsSchema, AudioSchema, BindingsSchema, BroadcastSchema } from "./agents.js";
import { ApprovalsSchema } from "./approvals.js";
import { ChannelsSchema } from "./channels-config.js";
import {
  HexColorSchema,
  ModelsConfigSchema,
  SecretInputSchema,
...
import { HookMappingSchema, HooksGmailSchema, InternalHooksSchema } from "./hooks.js";
      ...
      .object({
        ...
        controlUi: z
          .object({
            ...
            launchUrl: z
              .string()
              .transform((value) => normalizeControlUiLaunchUrl(value))
              .refine((value) => isValidControlUiLaunchUrl(value), {
                message:
                  "Expected an http(s) URL without credentials or URL fragment, for example https://control.example.com",
              })
              .optional(),
            embedSandbox: z
