...
import { writePackageDistInventory } from "../../infra/install/package-dist-inventory.js";
import { isBetaTag } from "../../infra/install/update-channels.js";
import {
...
vi.mock("../../infra/install/update-check.js", () => ({
...
vi.mock("../../infra/install/update-managed-service-handoff-cleanup.js", () => ({
...
vi.mock("./post-core-plugin-convergence.js", () => ({
...
vi.mock("../../commands/doctor/doctor-completion.js", () => ({
...
vi.mock("../program/completion-runtime.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../program/completion-runtime.js")>();
  return {
    ...actual,
...
vi.mock("../daemon-cli/daemon-cli.js", () => ({
...
const { runGatewayUpdate } = await import("../../infra/install/update-runner.js");
...
const { checkUpdateStatus, fetchNpmPackageTargetStatus, fetchNpmTagVersion, resolveNpmChannelTag } =
  await import("../../infra/install/update-check.js");
const { CONTROL_PLANE_UPDATE_SENTINEL_META_ENV } =
  await import("../../infra/install/update-control-plane-sentinel.js");
const { runCommandWithTimeout } = await import("../../process/exec.js");
const { runDaemonRestart, runDaemonInstall } = await import("../daemon-cli/daemon-cli.js");
...
const updateCliShared = await import("./shared.js");
