...
vi.mock("../../commands/status/status.js", () => ({ statusCommand: programMocks.statusCommand }));
vi.mock("../../commands/configure/configure.js", () => ({
...
vi.mock("../../commands/doctor/doctor-config-flow.js", () => ({
