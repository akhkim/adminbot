...
import { ensureCliPluginRegistryLoaded } from "../plugins/plugin-registry-loader.js";
import type { CliPluginRegistryPolicy } from "./command-catalog.js";
import { resolveCliCommandPathPolicy } from "./command-path-policy.js";

const configGuardModuleLoader = createLazyImportLoader(() => import("./config-guard.js"));
