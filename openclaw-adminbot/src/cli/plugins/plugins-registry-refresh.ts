...
import type { InstalledPluginIndexRefreshReason } from "../../plugins/install/installed-plugin-index.js";
...
async function invalidatePluginRuntimeDiscoveryAfterConfigMutation(params: {
  ...
  try {
    const { clearPluginRegistryLoadCache } = await import("../../plugins/runtime/loader.js");
