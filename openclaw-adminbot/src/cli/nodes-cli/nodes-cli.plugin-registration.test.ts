...
vi.mock("./register.camera.js", () => ({ registerNodesCameraCommands }));
vi.mock("./register.invoke.js", () => ({ registerNodesInvokeCommands }));
vi.mock("./register.location.js", () => ({ registerNodesLocationCommands }));
vi.mock("./register.notify.js", () => ({ registerNodesNotifyCommand }));
vi.mock("./register.pairing.js", () => ({ registerNodesPairingCommands }));
vi.mock("./register.push.js", () => ({ registerNodesPushCommand }));
vi.mock("./register.screen.js", () => ({ registerNodesScreenCommands }));
vi.mock("./register.status.js", () => ({ registerNodesStatusCommands }));

const { registerNodesCli } = await import("./register.js");
