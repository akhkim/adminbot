// oxlint-disable max-lines -- grandfathered at 2696 lines; see docs/adr/0006-deferred-monster-splits.md
...
import { readBestEffortRuntimeConfigSchema } from "../../config/runtime/runtime-schema.js";
...
import { SecretProviderSchema } from "../../config/zod/core.js";
  ...
  const cmd = program
    ...
    .action(async (opts) => {
      const { configureCommandFromSectionsArg } =
        await import("../../commands/configure/configure.js");
