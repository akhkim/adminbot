...
type RegistryModule = typeof import("../manifest/registry.js");
type RuntimeModule = typeof import("../runtime/runtime.js");
type WebSearchProvidersRuntimeModule = typeof import("./web-search-providers.runtime.js");
type PluginAutoEnableModule = typeof import("../../config/plugin/plugin-auto-enable.js");
type WebSearchProvidersSharedModule = typeof import("./web-search-providers.shared.js");
type PluginManifestRegistry = import("../manifest/manifest-registry.js").PluginManifestRegistry;
...
type LoadPluginManifestRegistryForInstalledIndex =
  typeof import("../manifest/manifest-registry-installed.js").loadPluginManifestRegistryForInstalledIndex;
...
let loaderModule: typeof import("../runtime/loader.js");
...
describe("resolvePluginWebSearchProviders", () => {
  beforeAll(async () => {
    ...
    vi.doMock("../manifest/manifest-registry.js", async () => {
      const actual = await vi.importActual<typeof import("../manifest/manifest-registry.js")>(
        "../manifest/manifest-registry.js",
      );
      return {
        ...actual,
    ...
    vi.doMock("../manifest/manifest-registry-installed.js", async () => {
      const actual = await vi.importActual<
        typeof import("../manifest/manifest-registry-installed.js")
      >("../manifest/manifest-registry-installed.js");
      return {
        ...actual,
    ...
    ({ createEmptyPluginRegistry } = await import("../manifest/registry-empty.js"));
    loaderModule = await import("../runtime/loader.js");
    pluginAutoEnableModule = await import("../../config/plugin/plugin-auto-enable.js");
