...
type LoaderModule = typeof import("../runtime/loader.js");
type ManifestRegistryModule = typeof import("../manifest/manifest-registry.js");
...
describe("resolvePluginWebFetchProviders", () => {
  beforeAll(async () => {
    ...
    manifestRegistryModule = await import("../manifest/manifest-registry.js");
