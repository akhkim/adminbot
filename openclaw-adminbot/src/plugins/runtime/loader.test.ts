...
} from "../config/interactive-state.js";
import {
...
} from "../hooks/hook-runner-global.js";
import { createHookRunner } from "../hooks/hooks.js";
import { writePersistedInstalledPluginIndexInstallRecordsSync } from "../install/installed-plugin-index-records.js";
...
} from "./runtime-registry-loader.js";
import {
...
module.exports = { id: "throws-after-import", register() {} };`,
  ...
  it("skips discovery and manifest registry loading entirely when onlyPluginIds is an explicit empty array", async () => {
    ...
    const manifestRegistry = await import("../manifest/manifest-registry.js");
