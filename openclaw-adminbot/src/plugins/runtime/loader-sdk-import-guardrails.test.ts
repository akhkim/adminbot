...
const ALLOWED_PLUGIN_SDK_FIXTURE_IMPORTS = new Set([
  ...
  'src/plugins/runtime/loader.test.ts:configSchema: (require("openclaw/plugin-sdk").emptyPluginConfigSchema)(),',
  'src/plugins/runtime/loader.test.ts:const { onDiagnosticEvent } = require("openclaw/plugin-sdk");',
  // Intentional jiti alias regression test.
  'src/plugins/runtime/loader.git-path-regression.test.ts:`import { resolveOutboundSendDep } from "openclaw/plugin-sdk/channel-outbound";',
  'src/plugins/runtime/loader.git-path-regression.test.ts:          "openclaw/plugin-sdk/channel-outbound": ${JSON.stringify(copiedChannelRuntimeShim)},',
  // Intentional packaged bundled-plugin SDK alias regression tests.
  'src/plugins/runtime/loader.test.ts:`import { normalizeLowercaseStringOrEmpty } from "openclaw/plugin-sdk/string-coerce-runtime";`,',
]);

const LOADER_FIXTURE_TEST_FILES = [
  "src/plugins/runtime/loader.cli-metadata.test.ts",
  "src/plugins/runtime/loader.git-path-regression.test.ts",
  "src/plugins/runtime/loader.test.ts",
];
