...
type PluginInstallSourceInfo = import("../install/install-source-info.js").PluginInstallSourceInfo;
type InstalledPluginInstallRecordInfo =
  import("../install/installed-plugin-index.js").InstalledPluginInstallRecordInfo;
type InstalledPluginIndexRecord =
  import("../install/installed-plugin-index.js").InstalledPluginIndexRecord;
