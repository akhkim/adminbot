...
import type { OpenClawPackageManifest } from "../manifest/manifest.js";
import { createEmptyPluginRegistry } from "../manifest/registry-empty.js";
import type { PluginMetadataSnapshot } from "../plugin-metadata-snapshot.types.js";
import type { PluginRegistrySnapshot } from "../plugin-registry.js";
import type { ProviderPlugin } from "../types.js";

type ResolveRuntimePluginRegistry =
  typeof import("../runtime/loader.js").resolveRuntimePluginRegistry;
type ResolveCompatibleRuntimePluginRegistry =
  typeof import("../runtime/loader.js").resolveCompatibleRuntimePluginRegistry;
type GetRuntimePluginRegistryForLoadOptions =
  typeof import("../runtime/loader.js").getRuntimePluginRegistryForLoadOptions;
type LoadOpenClawPlugins = typeof import("../runtime/loader.js").loadOpenClawPlugins;
type IsPluginRegistryLoadInFlight =
  typeof import("../runtime/loader.js").isPluginRegistryLoadInFlight;
type LoadPluginManifestRegistry =
  typeof import("../manifest/manifest-registry.js").loadPluginManifestRegistry;
type LoadPluginMetadataSnapshot =
  typeof import("../plugin-metadata-snapshot.js").loadPluginMetadataSnapshot;
type ApplyPluginAutoEnable =
  typeof import("../../config/plugin/plugin-auto-enable.js").applyPluginAutoEnable;
type SetActivePluginRegistry = typeof import("../runtime/runtime.js").setActivePluginRegistry;
...
describe("resolvePluginProviders", () => {
  beforeAll(async () => {
    ...
    vi.doMock("../install/installed-plugin-index-store.js", async (importOriginal) => {
      const actual =
        await importOriginal<typeof import("../install/installed-plugin-index-store.js")>();
      return {
        ...actual,
