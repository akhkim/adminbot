// oxlint-disable max-lines -- grandfathered at 3138 lines; see docs/adr/0006-deferred-monster-splits.md
...
import { clearCodeModeNamespacesForPlugin } from "../../agents/tools/code-mode-namespaces.js";
...
import { sendPluginSessionAttachment } from "../host/host-hook-attachments.js";
import {
...
import { enqueuePluginNextTurnInjection } from "../host/host-hook-state.js";
import {
  isPluginJsonValue,
...
import { normalizeRegisteredProvider } from "../providers/provider-validation.js";
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const { registerModelCatalogProvider, registerSynthesizedTextModelCatalogProvider } =
