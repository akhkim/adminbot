...
type OpenAiChatCompletionRequest = {
  model?: unknown;
  stream?: unknown;
  // Naming/style reference: src/agents/transport/openai-transport-stream.ts:1262-1273
...
function resolveIncludeUsageForStreaming(payload: OpenAiChatCompletionRequest): boolean {
  ...
  // Flow reference: src/agents/transport/openai-transport-stream.ts:1262-1273
