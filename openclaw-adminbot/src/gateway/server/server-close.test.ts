...
vi.mock("../../agents/mcp/agent-bundle-mcp-tools.js", async () => ({
  ...(await vi.importActual<typeof import("../../agents/mcp/agent-bundle-mcp-tools.js")>(
    "../../agents/mcp/agent-bundle-mcp-tools.js",
  )),
