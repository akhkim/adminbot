...
import type { PluginGatewayDiscoveryServiceRegistration } from "../../plugins/manifest/registry-types.js";

type WriteWideAreaGatewayZone =
  typeof import("../../infra/widearea-dns.js").writeWideAreaGatewayZone;
