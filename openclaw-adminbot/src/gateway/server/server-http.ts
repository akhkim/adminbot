...
import type { ControlUiRootState } from "../control/control-ui.js";
import type { AuthorizedGatewayHttpRequest } from "../http/http-auth-utils.js";
import { sendGatewayAuthFailure, setDefaultSecurityHeaders } from "../http/http-common.js";
import { resolveRequestClientIp } from "../net.js";
import {
  normalizePluginNodeCapabilityScopedUrl,
  type PluginNodeCapabilitySurface,
} from "../plugin-node-capability.js";
import type { HooksRequestHandler } from "./hooks-request-handler.js";
import {
...
let identityAvatarModulePromise:
  | Promise<typeof import("../../agents/identity-avatar.js")>
  | undefined;
let controlUiModulePromise: Promise<typeof import("../control/control-ui.js")> | undefined;
...
let openAiHttpModulePromise: Promise<typeof import("../protocol/openai-http.js")> | undefined;
let openResponsesHttpModulePromise:
  | Promise<typeof import("../protocol/openresponses-http.js")>
  | undefined;
let sessionHistoryHttpModulePromise:
  | Promise<typeof import("../sessions/sessions-history-http.js")>
  | undefined;
let sessionKillHttpModulePromise:
  | Promise<typeof import("../sessions/session-kill-http.js")>
  | undefined;
...
let pluginNodeCapabilityAuthModulePromise:
  | Promise<typeof import("./plugin-node-capability-auth.js")>
  | undefined;
let httpAuthUtilsModulePromise: Promise<typeof import("../http/http-auth-utils.js")> | undefined;
let pluginRouteRuntimeScopesModulePromise:
  | Promise<typeof import("./plugin-route-runtime-scopes.js")>
  | undefined;
...
function getControlUiModule() {
  controlUiModulePromise ??= import("../control/control-ui.js");
...
function getOpenAiHttpModule() {
  openAiHttpModulePromise ??= import("../protocol/openai-http.js");
  return openAiHttpModulePromise;
}

function getOpenResponsesHttpModule() {
  openResponsesHttpModulePromise ??= import("../protocol/openresponses-http.js");
  return openResponsesHttpModulePromise;
}

function getSessionHistoryHttpModule() {
  sessionHistoryHttpModulePromise ??= import("../sessions/sessions-history-http.js");
  return sessionHistoryHttpModulePromise;
}

function getSessionKillHttpModule() {
  sessionKillHttpModulePromise ??= import("../sessions/session-kill-http.js");
...
function getPluginNodeCapabilityAuthModule() {
  pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth.js");
  return pluginNodeCapabilityAuthModulePromise;
}

function getHttpAuthUtilsModule() {
  httpAuthUtilsModulePromise ??= import("../http/http-auth-utils.js");
  return httpAuthUtilsModulePromise;
}

function getPluginRouteRuntimeScopesModule() {
  pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes.js");
