...
let configIo: typeof import("../../config/io/io.js");
let configMutate: typeof import("../../config/mutate/mutate.js");
...
describe("gateway startup config validation", () => {
  beforeAll(async () => {
    ...
    configIo = await import("../../config/io/io.js");
    configMutate = await import("../../config/mutate/mutate.js");
  });
