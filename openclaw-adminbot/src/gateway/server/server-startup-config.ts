...
} from "../../cli/config/config-recovery-hints.js";
import {
  type ReadConfigFileSnapshotWithPluginMetadataResult,
  readConfigFileSnapshotWithPluginMetadata,
} from "../../config/io/io.js";
import { formatConfigIssueLines } from "../../config/issue-format.js";
import { isNixMode } from "../../config/paths/paths.js";
...
export function createRuntimeSecretsActivator(params: {
  ...
  let authProfilesPromise: Promise<typeof import("../../agents/auth/auth-profiles.js")> | null =
    null;
  ...
  const loadAuthProfiles = () => {
    authProfilesPromise ??= import("../../agents/auth/auth-profiles.js");
