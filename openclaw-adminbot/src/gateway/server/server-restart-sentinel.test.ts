...
type LoadedSessionEntry = ReturnType<
  typeof import("../sessions/session-utils.js").loadSessionEntry
>;
...
vi.mock("../../shared/delivery-context.shared.js", () => ({
...
vi.mock("../../infra/heartbeat/heartbeat-wake.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/heartbeat/heartbeat-wake.js")>(
    "../../infra/heartbeat/heartbeat-wake.js",
  );
  return {
    ...actual,
