...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "operator.secret.list", scope: "operator.approvals" },
  { name: "operator.secret.request", scope: "operator.approvals" },
  { name: "operator.secret.resolve", scope: "operator.approvals" },
