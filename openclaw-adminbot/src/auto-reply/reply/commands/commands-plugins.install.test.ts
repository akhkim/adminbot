...
vi.mock("../../../plugins/install/install.js", async () => {
  const actual = await vi.importActual<typeof import("../../../plugins/install/install.js")>(
    "../../../plugins/install/install.js",
  );
  return {
    ...actual,
...
vi.mock("../../../cli/plugins/plugins-install-persist.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../../../cli/plugins/plugins-install-persist.js")>()),
