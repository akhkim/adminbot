...
import { estimateMessagesTokens } from "../../../agents/compaction/compaction.js";
import { classifyCompactionReason } from "../../../agents/embedded-agent-runner/compact-reasons.js";
import { resolveAgentHarnessPolicy } from "../../../agents/harness/policy.js";
import { ensureSelectedAgentHarnessPlugin } from "../../../agents/harness/runtime-plugin.js";
import { runWithModelFallback } from "../../../agents/models/model-fallback.js";
import { isCliRuntimeAliasForProvider } from "../../../agents/models/model-runtime-aliases.js";
import { isCliProvider } from "../../../agents/models/model-selection.js";
import { resolveBootstrapWarningSignaturesSeen } from "../../../agents/prompt/bootstrap-budget.js";
import type { AgentMessage } from "../../../agents/runtime/index.js";
import {
  resolveSandboxConfigForAgent,
  resolveSandboxRuntimeStatus,
} from "../../../agents/sandbox/sandbox.js";
import { resolveContextConfigProviderForRuntime } from "../../../agents/transport/openai-routing.js";
import {
  derivePromptTokens,
  hasNonzeroUsage,
  normalizeUsage,
...
import { readSessionMessagesAsync } from "../../../gateway/sessions/session-utils.fs.js";
...
import { refreshQueuedFollowupSession, type FollowupRun } from "../queue/queue.js";
...
type EmbeddedAgentRuntime = typeof import("../../../agents/embedded/embedded-agent.js");
...
async function compactEmbeddedAgentSessionDefault(
  ...args: Parameters<
    typeof import("../../../agents/embedded/embedded-agent.js").compactEmbeddedAgentSession
  >
): Promise<
  Awaited<
    ReturnType<
...
async function runEmbeddedAgentDefault(
  ...args: Parameters<typeof import("../../../agents/embedded/embedded-agent.js").runEmbeddedAgent>
): Promise<
  Awaited<ReturnType<typeof import("../../../agents/embedded/embedded-agent.js").runEmbeddedAgent>>
> {
