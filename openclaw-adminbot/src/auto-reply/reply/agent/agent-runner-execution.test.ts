...
import { MissingProviderAuthError } from "../../../agents/auth/model-auth.js";
import { testing as cliBackendsTesting } from "../../../agents/cli-runner/cli-backends.js";
import { formatBillingErrorMessage } from "../../../agents/embedded/embedded-agent-helpers.js";
...
vi.mock("../../../agents/cli-runner/cli-runner.js", () => ({
...
vi.mock("../../../agents/prompt/bootstrap-budget.js", () => ({
  resolveBootstrapWarningSignaturesSeen: () => [],
}));

vi.mock("../../../agents/embedded/embedded-agent-helpers.js", async () => {
  const actual = await vi.importActual<
    typeof import("../../../agents/embedded/embedded-agent-helpers.js")
  >("../../../agents/embedded/embedded-agent-helpers.js");
  return {
