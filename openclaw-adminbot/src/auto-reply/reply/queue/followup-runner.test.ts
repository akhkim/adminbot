...
import { setCliSessionBinding } from "../../../agents/cli-runner/cli-session.js";
...
let resolveQueuedReplyExecutionConfigActual:
  | (typeof import("../agent/agent-runner-utils.js"))["resolveQueuedReplyExecutionConfig"]
  | undefined;
...
let sessionRunAccounting: typeof import("../session/session-run-accounting.js");
...
let cliBackendsTestingForTest: typeof import("../../../agents/cli-runner/cli-backends.js").testing;
...
async function incrementRunCompactionCountForFollowupTest(
  params: Parameters<
    typeof import("../session/session-run-accounting.js").incrementRunCompactionCount
  >[0],
...
async function persistRunSessionUsageForFollowupTest(
  params: Parameters<
    typeof import("../session/session-run-accounting.js").persistRunSessionUsage
  >[0],
): Promise<void> {
...
async function loadFreshFollowupRunnerModuleForTest() {
  ...
  vi.doMock("../../../agents/models/model-fallback.js", () => ({
    runWithModelFallback: (params: unknown) => runWithModelFallbackMock(params),
  }));
  vi.doMock("../../../agents/sessions/session-write-lock.js", () => ({
  ...
  vi.doMock("../../../agents/cli-runner/cli-runner.js", () => ({
  ...
  vi.doMock("../session/session-run-accounting.js", () => ({
  ...
  vi.doMock("../agent/agent-runner-memory.js", () => ({
  ...
  vi.doMock("../../../plugins/providers/provider-runtime.js", async () => {
  ...
  vi.doMock("../agent/agent-runner-utils.js", async () => {
    const actual = await vi.importActual<typeof import("../agent/agent-runner-utils.js")>(
      "../agent/agent-runner-utils.js",
    );
  ...
  vi.doMock("../../../cli/program/command-secret-gateway.js", () => ({
    resolveCommandSecretRefsViaGateway: (...args: unknown[]) =>
      resolveCommandSecretRefsViaGatewayMock(...args),
  }));
  vi.doMock("../../../cli/program/command-secret-targets.js", () => ({
  ...
  ({ testing: cliBackendsTestingForTest } =
    await import("../../../agents/cli-runner/cli-backends.js"));
  ...
  sessionRunAccounting = await import("../session/session-run-accounting.js");
