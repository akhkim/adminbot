...
import { isCliProvider } from "../../../agents/models/model-selection-cli.js";
...
} from "../agent/agent-lifecycle-terminal.js";
import {
  clearDroppedCliSessionBinding,
  createCliToolSummaryTracker,
  keepCliSessionBindingOnlyWhenReused,
  runCliAgentWithLifecycle,
} from "../agent/agent-runner-cli-dispatch.js";
import {
  buildCommandOutputFromToolResultEvent,
  buildPreflightCompactionFailureText,
  resolveRunAfterAutoFallbackPrimaryProbeRecheck,
  resolveSessionRuntimeOverrideForProvider,
} from "../agent/agent-runner-execution.js";
import { runPreflightCompactionIfNeeded } from "../agent/agent-runner-memory.js";
import {
  resolveQueuedReplyExecutionConfig,
  resolveQueuedReplyRuntimeConfig,
  resolveModelFallbackOptions,
  resolveRunAuthProfile,
} from "../agent/agent-runner-utils.js";
import {
