...
import type { PluginHookReplyDispatchEvent } from "../../../plugins/hooks/hook-types.js";
...
import { resolveSessionRuntimeOverrideForProvider } from "../agent/agent-runner-execution.js";
import {
...
import { withFullRuntimeReplyConfig } from "../get-reply/get-reply-fast-path.js";
import type { ReplySessionBinding } from "../get-reply/get-reply.types.js";
import {
  claimInboundDedupe,
  commitInboundDedupe,
  releaseInboundDedupe,
} from "../inbound/inbound-dedupe.js";
import { hasInboundAudio } from "../inbound/inbound-media.js";
import { resolveOriginMessageProvider } from "../origin-routing.js";
import { resolveRunTypingPolicy } from "../queue/typing-policy.js";
...
const getReplyFromConfigRuntimeLoader = createLazyImportLoader(
  () => import("../get-reply/get-reply-from-config.runtime.js"),
);
const abortRuntimeLoader = createLazyImportLoader(() => import("../queue/abort.runtime.js"));
...
export async function dispatchReplyFromConfig(
  ...
  //
  // Debug: `pnpm test src/auto-reply/reply/dispatch/dispatch-from-config.test.ts`
  ...
  try {
    ...
    const sendFinalPayload = async (
      ...
      throwIfFinalDeliveryAborted();
      const normalizedPayload = await normalizeReplyMediaPayload(payload);
      throwIfFinalDeliveryAborted();
            ...
            onBlockReply: (payload: ReplyPayload, context?: BlockReplyContext) => {
              ...
              const run = async () => {
                ...
                if (payload.text && !isStatusNotice) {
                  ...
                  if (accumulatedBlockTtsText.length > 0) {
                    accumulatedBlockTtsText += "\n";
                  }
                  accumulatedBlockTtsText += payload.text;
                  blockCount++;
                }
                // The visible payload used to be a TTS-directive-stripped copy; with TTS gone
                // the payload is already what the user sees.
