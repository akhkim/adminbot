...
} from "../../../infra/approvals/approval-native-route-coordinator.js";
import {
...
import { PROVIDER_CONVERSATION_STATE_ERROR_USER_MESSAGE } from "../providers/provider-request-error-classifier.js";
import {
...
vi.mock("../queue/abort.runtime.js", () => ({
...
let resetInboundDedupe: typeof import("../inbound/inbound-dedupe.js").resetInboundDedupe;
...
beforeAll(async () => {
  ...
  ({ resetInboundDedupe } = await import("../inbound/inbound-dedupe.js"));
...
describe("dispatchReplyFromConfig", () => {
  ...
  it("forwards payload metadata into onBlockReplyQueued context", async () => {
    ...
    const { setReplyPayloadMetadata: setReplyPayloadMetadataLocal } =
