...
import type { BlockReplyChunking } from "../../../agents/embedded/embedded-agent-block-chunker.js";
...
import type { buildStatusReply, handleCommands } from "../commands/commands.runtime.js";
...
} from "../queue/abort-cutoff.js";
import { getAbortMemory, isAbortRequestText } from "../queue/abort-primitives.js";
...
type AbortCutoffRuntime = typeof import("../queue/abort-cutoff.runtime.js");
type CommandsRuntime = typeof import("../commands/commands.runtime.js");
...
const abortCutoffRuntimeLoader = createLazyImportLoader<AbortCutoffRuntime>(
  () => import("../queue/abort-cutoff.runtime.js"),
);
const commandsRuntimeLoader = createLazyImportLoader<CommandsRuntime>(
  () => import("../commands/commands.runtime.js"),
);
