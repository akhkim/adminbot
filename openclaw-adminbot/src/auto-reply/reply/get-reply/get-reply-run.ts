...
import { hasInboundAudio, hasInboundMedia } from "../inbound/inbound-media.js";
import {
  buildInboundMetaSystemPrompt,
  buildInboundUserContextPrefix,
  resolveInboundUserContextPromptJoiner,
} from "../inbound/inbound-meta.js";
import type { createModelSelectionState } from "../model-selection.js";
import { resolveOriginMessageProvider } from "../origin-routing.js";
import { buildReplyPromptEnvelope, buildReplyPromptEnvelopeBase } from "../prompt-prelude.js";
import { resolveActiveRunQueueAction } from "../queue/queue-policy.js";
import { resolveQueueSettings } from "../queue/settings-runtime.js";
import { resolveTypingMode } from "../queue/typing-mode.js";
...
import { resolveBareSessionResetPromptState } from "../session/session-reset-prompt.js";
import { resolveBareResetBootstrapFileAccess } from "../session/session-reset-prompt.js";
import { drainFormattedSystemEvents } from "../session/session-system-events.js";
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(
  () => import("../../../agents/embedded/embedded-agent.runtime.js"),
);
const agentRunnerRuntimeLoader = createLazyImportLoader(
  () => import("../agent/agent-runner.runtime.js"),
);
const sessionUpdatesRuntimeLoader = createLazyImportLoader(
  () => import("../session/session-updates.runtime.js"),
);
