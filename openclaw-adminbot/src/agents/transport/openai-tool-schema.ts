...
import { shouldOmitEmptyArrayItems } from "../../plugins/providers/provider-model-compat.js";
import { normalizeToolParameterSchema } from "../tools/agent-tools-parameter-schema.js";
