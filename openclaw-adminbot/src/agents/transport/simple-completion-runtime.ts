...
import { prepareProviderRuntimeAuth } from "../../plugins/providers/provider-runtime.runtime.js";
...
import { splitTrailingAuthProfile } from "../models/model-ref-profile.js";
import {
...
async function setRuntimeApiKeyForCompletion(params: {
  ...
  if (params.model.provider === "github-copilot") {
    const { resolveCopilotApiToken } = await import("../auth/github-copilot-token.js");
