...
async function createGatewaySessionUtilsModuleMock() {
  const actual = await vi.importActual<typeof import("../../gateway/sessions/session-utils.js")>(
    "../../gateway/sessions/session-utils.js",
  );
  return {
    ...actual,
...
vi.mock("../../gateway/sessions/session-utils.js", createGatewaySessionUtilsModuleMock);
vi.mock("../../config/config.js", createConfigModuleMock);
vi.mock("../models/model-catalog.js", createModelCatalogModuleMock);
...
vi.mock("../auth/auth-profiles.js", createAuthProfilesModuleMock);
vi.mock("../auth/model-auth.js", createModelAuthModuleMock);
vi.mock("../../infra/providers/provider-usage.js", createProviderUsageModuleMock);
vi.mock("./session-status.runtime.js", createCommandsStatusRuntimeModuleMock);
vi.mock("../../auto-reply/group-activation.js", () => ({
  normalizeGroupActivation: (value: unknown) => value ?? "always",
}));
vi.mock("../../auto-reply/reply/queue/queue.js", () => ({
...
let createSessionStatusTool: typeof import("./session-status-tool.js").createSessionStatusTool;

beforeAll(async () => {
  ({ createSessionStatusTool } = await import("./session-status-tool.js"));
});
