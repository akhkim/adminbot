...
} from "../../infra/exec/exec-authorization-plan.js";
...
vi.mock("../../infra/exec/exec-approvals.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../../infra/exec/exec-approvals.js")>()),
...
vi.mock("../../infra/exec/exec-auto-review.js", () => ({
