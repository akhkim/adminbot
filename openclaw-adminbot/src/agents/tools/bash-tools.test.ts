...
import { drainFormattedSystemEvents } from "../../auto-reply/reply/session/session-system-events.js";
import type { OpenClawConfig } from "../../config/config.js";
import {
  resetHeartbeatWakeStateForTests,
  setHeartbeatWakeHandler,
} from "../../infra/heartbeat/heartbeat-wake.js";
import { applyPathPrepend, findPathKey } from "../../infra/system/path-prepend.js";
import {
...
vi.mock("../../infra/exec/exec-approval-surface.js", () => ({
...
vi.mock("../../shared/delivery-context.js", () => ({
...
vi.mock("../../infra/system/shell-env.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/system/shell-env.js")>(
    "../../infra/system/shell-env.js",
  );
  return {
    ...actual,
