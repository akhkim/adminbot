...
import type { SafeBinProfile } from "../../infra/exec/exec-safe-bin-policy.js";
import { isNativeApprovalChannel, normalizeMessageChannel } from "../../shared/message-channel.js";
