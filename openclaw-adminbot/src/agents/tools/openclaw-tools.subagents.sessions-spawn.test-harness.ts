...
import type { SubagentLifecycleHookRunner } from "../../plugins/hooks/hooks.js";
import { resolveRequesterStoreKey } from "../subagents/subagent-requester-store-key.js";
...
type CaptureSubagentCompletionReply =
  (typeof import("../subagents/subagent-announce.js"))["captureSubagentCompletionReply"];
type RunSubagentAnnounceFlow =
  (typeof import("../subagents/subagent-announce.js"))["runSubagentAnnounceFlow"];
type CreateSessionsSpawnTool =
  (typeof import("./sessions-spawn-tool.js"))["createSessionsSpawnTool"];
type SubagentRegistryTesting = (typeof import("../subagents/subagent-registry.js"))["testing"];
type SubagentSpawnTesting = (typeof import("../subagents/subagent-spawn.js"))["testing"];
...
export async function getSessionsSpawnTool(opts: CreateOpenClawToolsOpts) {
  ...
  if (!cachedSubagentSpawnTesting || !cachedSubagentRegistryTesting) {
    const [{ testing: subagentSpawnTesting }, { testing: subagentRegistryTesting }] =
      await Promise.all([
        import("../subagents/subagent-spawn.js"),
        import("../subagents/subagent-registry.js"),
      ]);
