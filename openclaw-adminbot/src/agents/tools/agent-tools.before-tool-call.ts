...
import { deriveToolParams } from "../../plugins/host/host-tool-param-parsers.js";
...
export async function runBeforeToolCallHook(args: {
  ...
  try {
    ...
    // Skill Workshop was the only core tool policy; with it gone nothing gates a call before the
    // trusted policies and plugin hooks run, so a tool with neither runs unimpeded.
