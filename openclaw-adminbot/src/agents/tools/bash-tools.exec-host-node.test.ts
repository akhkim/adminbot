...
import type { ExecAllowlistEntry } from "../../infra/exec/exec-approvals.types.js";
...
type ExecAutoReviewer =
  typeof import("../../infra/exec/exec-auto-review.js").defaultExecAutoReviewer;
type ExecAsk = import("../../infra/exec/exec-approvals.js").ExecAsk;
type ExecSecurity = import("../../infra/exec/exec-approvals.js").ExecSecurity;
type MockAllowAlwaysPersistenceInput = Parameters<
  typeof import("../../infra/exec/exec-approvals.js").resolveAllowAlwaysPersistenceDecision
>[0];
type MockAllowAlwaysPersistenceDecision =
  import("../../infra/exec/exec-approvals.js").AllowAlwaysPersistenceDecision;
type MockExecApprovalDecision = import("../../infra/exec/exec-approvals.js").ExecApprovalDecision;
type MockExecApprovalUnavailableDecision =
  import("../../infra/exec/exec-approvals.js").ExecApprovalUnavailableDecision;
...
vi.mock("../../infra/exec/exec-approvals.js", () => ({
...
vi.mock("../../infra/system/system-run-approval-context.js", () => ({
