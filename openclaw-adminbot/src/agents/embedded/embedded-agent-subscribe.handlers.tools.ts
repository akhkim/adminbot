...
import { normalizeAcceptedSessionSpawnResult } from "../subagents/accepted-session-spawn.js";
import {
  consumeAdjustedParamsForToolCall,
  consumePreExecutionBlockedToolCall,
  consumeStructuredReplaySafeToolCall,
} from "../tools/agent-tools.before-tool-call.state.js";
import { REQUIRED_PARAM_GROUPS, type RequiredParamGroup } from "../tools/agent-tools.params.js";
import type { ApplyPatchSummary } from "../tools/apply-patch.js";
import type { ExecToolDetails } from "../tools/bash-tools.exec-types.js";
...
type ExecApprovalReplyModule = typeof import("../../infra/exec/exec-approval-reply.js");
type HookRunnerGlobalModule = typeof import("../../plugins/hooks/hook-runner-global.js");
type ChannelToolProgress = {
  text: string;
};

const execApprovalReplyModuleLoader = createLazyImportLoader<ExecApprovalReplyModule>(
  () => import("../../infra/exec/exec-approval-reply.js"),
);
const hookRunnerGlobalModuleLoader = createLazyImportLoader<HookRunnerGlobalModule>(
  () => import("../../plugins/hooks/hook-runner-global.js"),
);
