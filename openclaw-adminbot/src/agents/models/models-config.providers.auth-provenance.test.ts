...
type ProviderRuntimeModule = typeof import("../../plugins/providers/provider-runtime.js");

let NON_ENV_SECRETREF_MARKER: typeof import("../auth/model-auth-markers.js").NON_ENV_SECRETREF_MARKER;
let MINIMAX_OAUTH_MARKER: typeof import("../auth/model-auth-markers.js").MINIMAX_OAUTH_MARKER;
let CUSTOM_LOCAL_AUTH_MARKER: typeof import("../auth/model-auth-markers.js").CUSTOM_LOCAL_AUTH_MARKER;
...
async function loadProviderAuthModules() {
  ...
  const [providerRuntimeModule, markersModule, helperModule, secretsModule] = await Promise.all([
    import("../../plugins/providers/provider-runtime.js"),
    import("../auth/model-auth-markers.js"),
