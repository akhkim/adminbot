...
const installRunEmbeddedMocks = () => {
  ...
  vi.doMock("../sessions/session-suspension.js", async () => {
    const actual = await vi.importActual<typeof import("../sessions/session-suspension.js")>(
      "../sessions/session-suspension.js",
    );
