...
describe("loadModelCatalog", () => {
  beforeAll(async () => {
    ...
    vi.doMock("../../plugins/providers/provider-runtime.runtime.js", () => ({
    ...
    const providerRuntime = await import("../../plugins/providers/provider-runtime.runtime.js");
  ...
  afterAll(() => {
    ...
    vi.doUnmock("../../plugins/manifest/manifest-contract-eligibility.js");
  });
