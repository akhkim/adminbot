...
// written, so there is one validator (see extensions/adminbot/src/service-core.ts).
...
// Mirrors ADMINBOT_OPEN_PROJECT in extensions/adminbot/src/contracts.ts: a sentinel project
