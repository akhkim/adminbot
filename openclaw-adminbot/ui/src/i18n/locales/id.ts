...
export const id: TranslationMap = {
  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        title: "Gagal masuk",
        summary: "Email dan kata sandi itu tidak cocok dengan akun anggota lab mana pun.",
        stepCredentials: "Periksa email dan kata sandi Anda, lalu coba lagi.",
        stepClaim: "Jika Anda belum menyetel kata sandi, gunakan “Claim your account”.",
      },
      memberClaim: {
        title: "Tidak dapat mengklaim akun",
        summary:
          "Akun tidak dapat diklaim. Mungkin sudah diklaim, emailnya tidak memenuhi syarat, atau kata sandinya terlalu lemah.",
        stepPassword: "Gunakan kata sandi minimal 10 karakter.",
        stepSignIn: "Jika Anda sudah mengklaim akun ini, gunakan “Sign in”.",
      },
      memberRateLimited: {
        title: "Terlalu banyak percobaan",
        summary: "Terlalu banyak percobaan masuk. Tunggu sebentar sebelum mencoba lagi.",
        summarySeconds: "Terlalu banyak percobaan masuk. Coba lagi sekitar {seconds} detik.",
        stepWait: "Berhenti mencoba sampai masa tunggu berakhir, lalu masuk lagi.",
      },
      memberPending: {
        title: "Menunggu persetujuan",
        summary: "Akun Anda menunggu persetujuan admin, jadi belum bisa masuk.",
        stepWait: "Tunggu sampai admin menyetujui akun Anda, lalu masuk lagi.",
        stepContact: "Jika sudah lama, hubungi admin untuk meninjau permintaan Anda.",
      },
      unreachable: {
        title: "Layanan AdminBot tidak dapat dihubungi",
        summary: "Tidak dapat menghubungi layanan AdminBot. Apakah layanan berjalan di port 8765?",
        stepService: "Pastikan layanan AdminBot berjalan dan mendengarkan di port 8765.",
        stepRetry: "Setelah layanan dapat dihubungi, masuk lagi.",
      },
    },
  },
  chat: {
