...
export const en: TranslationMap = {
  ...
  adminbotTimeAvailability: {
    ...
    chartSubtitle: "Task effort averaged across the selected daily, weekly, or monthly interval.",
    day: "Daily",
  ...
  dashboard: {
    ...
    attention: {
      title: "Needs you",
      // Shown in place of the stack when nothing is waiting. An empty screen is an invitation, not
      // a shrug, so it names what the reader can go do instead.
    ...
    profileSummary: {
      ...
      blanks: "{count} field still blank.",
      blanksPlural: "{count} fields still blank.",
      badges: "{count} badge",
      badgesPlural: "{count} badges",
      open: "Open profile",
    },
    workSummary: {
  ...
  myWork: {
    ...
    blockers: {
      ...
      // The prototype has nowhere to send this yet; say so rather than implying it was filed.
