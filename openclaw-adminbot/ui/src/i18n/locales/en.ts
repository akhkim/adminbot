...
export const en: TranslationMap = {
  ...
  adminbotMeetings: {
    ...
    decisions: "Decisions",
    empty: "No meeting recordings yet. One appears here within the hour after a cloud recording finishes.",
    file: "File meeting",
  ...
  adminbotTimeAvailability: {
    ...
    milestones: {
      ...
      addConference: "Add a conference or workshop",
      label: "What",
  ...
  logistics: {
    admin: {
      title: "Requests",
      badge: "Admins only",
      sub: "Make a request of your own, or read the ones already saved.",
      make: "Make a Request",
    ...
    requests: {
      ...
      scope:
        "Prototype: a request is saved in the browser it was typed in and never leaves that device, so this list shows the ones saved here. It covers the lab once requests are submitted to the service.",
      loading: "Reading saved requests…",
      empty: "No saved requests on this device yet.",
      user: "User",
      ...
      none: "None",
      back: "All requests",
      detailSub: "{type} · saved {saved}",
      detailDeadline: "most recent deadline {date}",
      savedUnknown: "not yet saved",
