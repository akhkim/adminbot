...
export const en: TranslationMap = {
  ...
  nav: {
    ...
    control: "Control",
    adminbot: "AdminBot",
    adminbotMember: "AdminBot",
    adminbotAdmin: "AdminBot Admin",
    adminbotGuest: "Guest Access",
    agent: "Agent",
    settings: "Settings",
  ...
  adminbotTimeAvailability: {
    ...
    capacityNote:
      "Dashed line marks 100% of available time. A period's total turns amber near capacity, red past it.",
    chartAria: "Time allocation chart for {member}",
    chartSubtitle:
      "Periods are computed from the selected member's saved start and end dates; overlapping effort is stacked.",
    day: "Day",
