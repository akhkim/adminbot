  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary:
          "Questa email e questa password non corrispondono a nessun account di un membro del laboratorio.",
        stepCredentials: "Controlla email e password, poi riprova.",
        stepClaim: "Se non hai ancora impostato una password, usa “Claim your account”.",
      },
      memberClaim: {
        title: "Impossibile rivendicare l'account",
        summary:
          "Non è stato possibile rivendicare l'account. Potrebbe essere già stato rivendicato, l'email potrebbe non essere idonea oppure la password è troppo debole.",
        stepPassword: "Usa una password di almeno 10 caratteri.",
        stepSignIn: "Se hai già rivendicato questo account, usa invece “Sign in”.",
      },
      memberRateLimited: {
        title: "Troppi tentativi",
        summary: "Troppi tentativi di accesso. Attendi un momento prima di riprovare.",
        summarySeconds: "Troppi tentativi di accesso. Riprova tra circa {seconds} secondi.",
        stepWait: "Smetti di riprovare finché non scade l'attesa, poi accedi di nuovo.",
      },
      memberPending: {
        title: "In attesa di approvazione",
        summary:
          "Il tuo account è in attesa dell'approvazione di un amministratore, quindi non può ancora accedere.",
        stepWait: "Attendi che un amministratore approvi il tuo account, poi accedi di nuovo.",
        stepContact:
          "Se è passato un po' di tempo, contatta un amministratore per far esaminare la richiesta.",
      },
      unreachable: {
        title: "Servizio AdminBot irraggiungibile",
        summary: "Impossibile raggiungere il servizio AdminBot. È in esecuzione sulla porta 8765?",
        stepService:
          "Verifica che il servizio AdminBot sia in esecuzione e in ascolto sulla porta 8765.",
        stepRetry: "Quando il servizio è raggiungibile, accedi di nuovo.",
      },
    },
  },
  chat: {
