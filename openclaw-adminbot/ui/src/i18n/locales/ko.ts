...
export const ko: TranslationMap = {
  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        title: "로그인하지 못했습니다",
        summary: "해당 이메일과 비밀번호와 일치하는 랩 구성원 계정이 없습니다.",
        stepCredentials: "이메일과 비밀번호를 확인한 뒤 다시 시도하세요.",
        stepClaim: "아직 비밀번호를 설정하지 않았다면 ‘Claim your account’를 사용하세요.",
      },
      memberClaim: {
      ...
      memberRateLimited: {
        title: "시도 횟수가 너무 많습니다",
        summary: "로그인 시도가 너무 많습니다. 잠시 기다린 뒤 다시 시도하세요.",
        summarySeconds: "로그인 시도가 너무 많습니다. 약 {seconds}초 후에 다시 시도하세요.",
        stepWait: "대기 시간이 끝날 때까지 재시도를 멈춘 뒤 다시 로그인하세요.",
      },
      memberPending: {
        title: "승인 대기 중",
        summary: "계정이 관리자 승인을 기다리고 있어 아직 로그인할 수 없습니다.",
        stepWait: "관리자가 계정을 승인할 때까지 기다린 뒤 다시 로그인하세요.",
        stepContact: "시간이 꽤 지났다면 관리자에게 요청 검토를 문의하세요.",
      },
      unreachable: {
        title: "AdminBot 서비스에 연결할 수 없음",
        summary: "AdminBot 서비스에 연결하지 못했습니다. 8765 포트에서 실행 중인가요?",
        stepService: "AdminBot 서비스가 실행 중이며 8765 포트에서 수신 대기하는지 확인하세요.",
        stepRetry: "서비스에 연결할 수 있게 되면 다시 로그인하세요.",
      },
    },
  },
  chat: {
