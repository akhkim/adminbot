...
export const ar: TranslationMap = {
  ...
  adminbotTimeAvailability: {
    ...
    capacityNote: "The dashed line marks 100% of the member's weekly capacity.",
    chartAria: "Time allocation chart for {member}",
    chartSubtitle: "Task effort across the selected timeline.",
    day: "Day",
    empty: "Select a user to view their time allocation.",
    endDate: "End date",
    effort: "Effort",
    interval: "Display by",
    label: "Time Avaliability:",
    loadingUsers: "Loading users...",
    missingCapacity: "Set this user's weekly capacity before charting their saved allocations.",
    month: "Month",
    noAllocations: "This user has no saved time allocations.",
    segmentTooltip:
      "{task}: {effort}% from {start} to {end}. Total allocation for this period: {total}%.",
