  ...
  logistics: {
    ...
    request: {
      ...
      blocked: {
        ...
        noDocPrep:
          "Every meeting needs a doc prep link. It is what the call is spent on, and a request without one cannot go on the queue.",
  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary: "لا يطابق هذا البريد الإلكتروني وكلمة المرور أي حساب عضو في المختبر.",
        stepCredentials: "تحقّق من بريدك الإلكتروني وكلمة المرور ثم حاول مرة أخرى.",
        stepClaim: "إذا لم تُعيّن كلمة مرور بعد، استخدم «Claim your account».",
      },
      memberClaim: {
        title: "تعذّرت المطالبة بالحساب",
        summary:
          "تعذّرت المطالبة بالحساب. ربما تمت المطالبة به من قبل، أو أن البريد الإلكتروني غير مؤهل، أو أن كلمة المرور ضعيفة جدًا.",
        stepPassword: "استخدم كلمة مرور من 10 أحرف على الأقل.",
        stepSignIn: "إذا سبق أن طالبت بهذا الحساب، استخدم «Sign in» بدلًا من ذلك.",
      },
      memberRateLimited: {
        title: "محاولات كثيرة جدًا",
        summary: "محاولات تسجيل دخول كثيرة جدًا. انتظر لحظة قبل المحاولة مرة أخرى.",
        summarySeconds: "محاولات تسجيل دخول كثيرة جدًا. حاول مرة أخرى بعد {seconds} ثانية تقريبًا.",
        stepWait: "توقّف عن المحاولة حتى تنتهي مدة الانتظار، ثم سجّل الدخول من جديد.",
      },
      memberPending: {
        title: "في انتظار الموافقة",
        summary: "حسابك في انتظار موافقة المسؤول، لذا لا يمكنه تسجيل الدخول بعد.",
        stepWait: "انتظر حتى يوافق أحد المسؤولين على حسابك، ثم سجّل الدخول مرة أخرى.",
        stepContact: "إذا مضى وقت طويل، تواصل مع أحد المسؤولين لمراجعة طلبك.",
      },
      unreachable: {
        title: "خدمة AdminBot غير متاحة",
        summary: "تعذّر الوصول إلى خدمة AdminBot. هل تعمل على المنفذ 8765؟",
        stepService: "تأكّد من أن خدمة AdminBot تعمل وتستمع على المنفذ 8765.",
        stepRetry: "بعد أن تصبح الخدمة متاحة، سجّل الدخول مرة أخرى.",
      },
    },
  },
  chat: {
