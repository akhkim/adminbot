...
export const zh_CN: TranslationMap = {
  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        title: "登录失败",
        summary: "该邮箱和密码与任何实验室成员账号都不匹配。",
        stepCredentials: "请检查邮箱和密码，然后重试。",
        stepClaim: "如果还没有设置密码，请使用“Claim your account”。",
      },
      memberClaim: {
        title: "无法认领账号",
        summary: "无法认领该账号。它可能已被认领，邮箱可能不符合条件，或者密码过于简单。",
        stepPassword: "请使用至少 10 个字符的密码。",
        stepSignIn: "如果你已经认领过该账号，请改用“Sign in”。",
      },
      memberRateLimited: {
        title: "尝试次数过多",
        summary: "登录尝试次数过多。请稍候再试。",
        summarySeconds: "登录尝试次数过多。请在约 {seconds} 秒后重试。",
        stepWait: "在冷却时间结束前请勿重试，之后再重新登录。",
      },
      memberPending: {
        title: "等待审批",
        summary: "你的账号正在等待管理员审批，暂时无法登录。",
        stepWait: "等待管理员审批你的账号，然后重新登录。",
        stepContact: "如果已等待较久，请联系管理员查看你的申请。",
      },
      unreachable: {
        title: "无法连接 AdminBot 服务",
        summary: "无法连接 AdminBot 服务。它是否运行在 8765 端口？",
        stepService: "请确认 AdminBot 服务正在运行并监听 8765 端口。",
        stepRetry: "服务恢复可用后，请重新登录。",
      },
    },
  },
  chat: {
