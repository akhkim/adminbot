  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary: "Ten adres e-mail i hasło nie pasują do żadnego konta członka laboratorium.",
        stepCredentials: "Sprawdź adres e-mail i hasło, a następnie spróbuj ponownie.",
        stepClaim: "Jeśli nie masz jeszcze ustawionego hasła, użyj „Claim your account”.",
      },
      memberClaim: {
        title: "Nie udało się przejąć konta",
        summary:
          "Nie udało się przejąć konta. Mogło już zostać przejęte, adres e-mail może nie być uprawniony albo hasło jest zbyt słabe.",
        stepPassword: "Użyj hasła o długości co najmniej 10 znaków.",
        stepSignIn: "Jeśli już przejąłeś to konto, użyj „Sign in”.",
      },
      memberRateLimited: {
        title: "Zbyt wiele prób",
        summary: "Zbyt wiele prób logowania. Odczekaj chwilę przed kolejną próbą.",
        summarySeconds: "Zbyt wiele prób logowania. Spróbuj ponownie za około {seconds} s.",
        stepWait: "Przerwij próby do końca odczekiwania, a potem zaloguj się ponownie.",
      },
      memberPending: {
        title: "Oczekuje na zatwierdzenie",
        summary:
          "Twoje konto czeka na zatwierdzenie przez administratora, więc nie może się jeszcze zalogować.",
        stepWait: "Poczekaj, aż administrator zatwierdzi konto, a potem zaloguj się ponownie.",
        stepContact:
          "Jeśli mija już sporo czasu, skontaktuj się z administratorem, aby sprawdził zgłoszenie.",
      },
      unreachable: {
        title: "Usługa AdminBot niedostępna",
        summary: "Nie udało się połączyć z usługą AdminBot. Czy działa na porcie 8765?",
        stepService: "Sprawdź, czy usługa AdminBot działa i nasłuchuje na porcie 8765.",
        stepRetry: "Gdy usługa będzie dostępna, zaloguj się ponownie.",
      },
    },
  },
  chat: {
