  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary:
          "Email và mật khẩu này không khớp với tài khoản thành viên nào của phòng thí nghiệm.",
        stepCredentials: "Kiểm tra lại email và mật khẩu của bạn, rồi thử lại.",
        stepClaim: "Nếu bạn chưa đặt mật khẩu, hãy dùng “Claim your account”.",
      },
      memberClaim: {
        title: "Không thể nhận tài khoản",
        summary:
          "Không thể nhận tài khoản. Có thể tài khoản đã được nhận, email không đủ điều kiện, hoặc mật khẩu quá yếu.",
        stepPassword: "Dùng mật khẩu có ít nhất 10 ký tự.",
        stepSignIn: "Nếu bạn đã nhận tài khoản này, hãy dùng “Sign in”.",
      },
      memberRateLimited: {
        title: "Quá nhiều lần thử",
        summary: "Quá nhiều lần đăng nhập. Hãy đợi một lát rồi thử lại.",
        summarySeconds: "Quá nhiều lần đăng nhập. Thử lại sau khoảng {seconds} giây.",
        stepWait: "Ngừng thử lại cho đến khi hết thời gian chờ, rồi đăng nhập lại.",
      },
      memberPending: {
        title: "Đang chờ phê duyệt",
        summary: "Tài khoản của bạn đang chờ quản trị viên phê duyệt nên chưa thể đăng nhập.",
        stepWait: "Đợi quản trị viên phê duyệt tài khoản, rồi đăng nhập lại.",
        stepContact: "Nếu đã lâu, hãy liên hệ quản trị viên để xem xét yêu cầu của bạn.",
      },
      unreachable: {
        title: "Không kết nối được dịch vụ AdminBot",
        summary: "Không kết nối được dịch vụ AdminBot. Dịch vụ có đang chạy ở cổng 8765 không?",
        stepService: "Xác nhận dịch vụ AdminBot đang chạy và lắng nghe ở cổng 8765.",
        stepRetry: "Khi dịch vụ đã kết nối được, hãy đăng nhập lại.",
      },
    },
  },
  chat: {
