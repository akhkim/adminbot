  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary: "Bu e-posta ve parola hiçbir laboratuvar üyesi hesabıyla eşleşmedi.",
        stepCredentials: "E-postanı ve parolanı kontrol edip yeniden dene.",
        stepClaim: "Henüz bir parola belirlemediysen “Claim your account” seçeneğini kullan.",
      },
      memberClaim: {
        title: "Hesap sahiplenilemedi",
        summary:
          "Hesap sahiplenilemedi. Zaten sahiplenilmiş olabilir, e-posta uygun olmayabilir ya da parola çok zayıf olabilir.",
        stepPassword: "En az 10 karakterli bir parola kullan.",
        stepSignIn: "Bu hesabı zaten sahiplendiysen bunun yerine “Sign in” seçeneğini kullan.",
      },
      memberRateLimited: {
        title: "Çok fazla deneme",
        summary: "Çok fazla oturum açma denemesi yapıldı. Yeniden denemeden önce biraz bekle.",
        summarySeconds:
          "Çok fazla oturum açma denemesi yapıldı. Yaklaşık {seconds} saniye sonra yeniden dene.",
        stepWait: "Bekleme süresi geçene kadar denemeyi bırak, sonra yeniden oturum aç.",
      },
      memberPending: {
        title: "Onay bekleniyor",
        summary: "Hesabın yönetici onayını bekliyor, bu yüzden henüz oturum açamaz.",
        stepWait: "Bir yönetici hesabını onaylayana kadar bekle, sonra yeniden oturum aç.",
        stepContact: "Bir süre geçtiyse, isteğini incelemesi için bir yöneticiye ulaş.",
      },
      unreachable: {
        title: "AdminBot hizmetine ulaşılamıyor",
        summary: "AdminBot hizmetine ulaşılamadı. 8765 numaralı bağlantı noktasında çalışıyor mu?",
        stepService:
          "AdminBot hizmetinin çalıştığını ve 8765 numaralı bağlantı noktasını dinlediğini doğrula.",
        stepRetry: "Hizmete ulaşılabilir olunca yeniden oturum aç.",
      },
    },
  },
  chat: {
