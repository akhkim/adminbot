  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary: "این ایمیل و گذرواژه با هیچ حساب عضو آزمایشگاه مطابقت ندارد.",
        stepCredentials: "ایمیل و گذرواژه خود را بررسی کنید و دوباره تلاش کنید.",
        stepClaim: "اگر هنوز گذرواژه‌ای تعیین نکرده‌اید، از «Claim your account» استفاده کنید.",
      },
      memberClaim: {
        title: "تصاحب حساب ممکن نشد",
        summary:
          "تصاحب حساب ممکن نشد. ممکن است قبلاً تصاحب شده باشد، ایمیل واجد شرایط نباشد یا گذرواژه بیش از حد ساده باشد.",
        stepPassword: "از گذرواژه‌ای با حداقل 10 نویسه استفاده کنید.",
        stepSignIn: "اگر قبلاً این حساب را تصاحب کرده‌اید، از «Sign in» استفاده کنید.",
      },
      memberRateLimited: {
        title: "تلاش‌های بیش از حد",
        summary: "تلاش‌های ورود بیش از حد زیاد بوده است. کمی صبر کنید و دوباره تلاش کنید.",
        summarySeconds:
          "تلاش‌های ورود بیش از حد زیاد بوده است. حدود {seconds} ثانیه دیگر دوباره تلاش کنید.",
        stepWait: "تا پایان مهلت انتظار تلاش نکنید، سپس دوباره وارد شوید.",
      },
      memberPending: {
        title: "در انتظار تأیید",
        summary: "حساب شما در انتظار تأیید مدیر است و هنوز نمی‌تواند وارد شود.",
        stepWait: "منتظر بمانید تا مدیری حساب شما را تأیید کند، سپس دوباره وارد شوید.",
        stepContact: "اگر مدتی گذشته است، برای بررسی درخواستتان با یک مدیر تماس بگیرید.",
      },
      unreachable: {
        title: "سرویس AdminBot در دسترس نیست",
        summary: "دسترسی به سرویس AdminBot ممکن نشد. آیا روی پورت 8765 در حال اجراست؟",
        stepService: "مطمئن شوید سرویس AdminBot در حال اجرا و در حال گوش دادن روی پورت 8765 است.",
        stepRetry: "پس از در دسترس شدن سرویس، دوباره وارد شوید.",
      },
    },
  },
  chat: {
