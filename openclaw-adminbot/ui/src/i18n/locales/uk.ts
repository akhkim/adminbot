  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary:
          "Ця електронна пошта та пароль не відповідають жодному обліковому запису учасника лабораторії.",
        stepCredentials: "Перевірте електронну пошту та пароль і спробуйте ще раз.",
        stepClaim: "Якщо ви ще не встановили пароль, скористайтеся «Claim your account».",
      },
      memberClaim: {
        title: "Не вдалося привʼязати обліковий запис",
        summary:
          "Не вдалося привʼязати обліковий запис. Можливо, його вже привʼязано, електронна пошта не підходить або пароль надто слабкий.",
        stepPassword: "Використовуйте пароль щонайменше з 10 символів.",
        stepSignIn: "Якщо ви вже привʼязали цей обліковий запис, скористайтеся «Sign in».",
      },
      memberRateLimited: {
        title: "Забагато спроб",
        summary: "Забагато спроб входу. Зачекайте трохи, перш ніж спробувати знову.",
        summarySeconds: "Забагато спроб входу. Спробуйте ще раз приблизно через {seconds} секунд.",
        stepWait: "Не повторюйте спроби до кінця очікування, потім увійдіть знову.",
      },
      memberPending: {
        title: "Очікує підтвердження",
        summary:
          "Ваш обліковий запис очікує підтвердження адміністратора, тож увійти поки не можна.",
        stepWait:
          "Зачекайте, поки адміністратор підтвердить ваш обліковий запис, потім увійдіть знову.",
        stepContact:
          "Якщо минуло чимало часу, зверніться до адміністратора, щоб він розглянув запит.",
      },
      unreachable: {
        title: "Служба AdminBot недоступна",
        summary: "Не вдалося зʼєднатися зі службою AdminBot. Чи запущена вона на порту 8765?",
        stepService: "Переконайтеся, що служба AdminBot запущена й слухає порт 8765.",
        stepRetry: "Щойно служба стане доступною, увійдіть знову.",
      },
    },
  },
  chat: {
