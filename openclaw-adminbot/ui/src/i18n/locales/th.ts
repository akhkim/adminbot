  ...
  login: {
    ...
    failure: {
      ...
      memberAuth: {
        ...
        summary: "อีเมลและรหัสผ่านนี้ไม่ตรงกับบัญชีสมาชิกของแล็บ",
        stepCredentials: "ตรวจสอบอีเมลและรหัสผ่านของคุณ แล้วลองอีกครั้ง",
        stepClaim: "หากยังไม่ได้ตั้งรหัสผ่าน ให้ใช้ “Claim your account”",
      },
      memberClaim: {
      ...
      memberRateLimited: {
        ...
        summary: "พยายามลงชื่อเข้าใช้มากเกินไป โปรดรอสักครู่แล้วลองใหม่",
        summarySeconds: "พยายามลงชื่อเข้าใช้มากเกินไป ลองใหม่ในอีกประมาณ {seconds} วินาที",
        stepWait: "หยุดลองใหม่จนกว่าจะพ้นเวลารอ แล้วจึงลงชื่อเข้าใช้อีกครั้ง",
      },
      memberPending: {
        title: "รอการอนุมัติ",
        summary: "บัญชีของคุณกำลังรอผู้ดูแลระบบอนุมัติ จึงยังลงชื่อเข้าใช้ไม่ได้",
        stepWait: "รอให้ผู้ดูแลระบบอนุมัติบัญชีของคุณ แล้วลงชื่อเข้าใช้อีกครั้ง",
        stepContact: "หากผ่านมาสักระยะแล้ว โปรดติดต่อผู้ดูแลระบบเพื่อตรวจสอบคำขอของคุณ",
      },
      unreachable: {
        title: "เชื่อมต่อบริการ AdminBot ไม่ได้",
        summary: "ไม่สามารถเชื่อมต่อบริการ AdminBot ได้ บริการทำงานอยู่ที่พอร์ต 8765 หรือไม่",
        stepService: "ตรวจสอบว่าบริการ AdminBot ทำงานอยู่และรับการเชื่อมต่อที่พอร์ต 8765",
        stepRetry: "เมื่อเชื่อมต่อบริการได้แล้ว ให้ลงชื่อเข้าใช้อีกครั้ง",
      },
    },
  },
  chat: {
