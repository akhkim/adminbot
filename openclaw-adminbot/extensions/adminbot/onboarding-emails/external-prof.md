...
matrix_grants: spreadsheet_basic, slack_connect_friends_channel, backend_email_triggers
source: supplied verbatim by the lab
placeholders: {first_name}, {project_or_context}, {update_cadence} (default: 2 to 4 weeks), {contact_name}, {next_steps}, {sender_name}, {slack_connect_link}
omitted_internal_items: spreadsheet_basic
enriched: |
  The lab text was extended with the two matrix grants it did not cover: the Slack
