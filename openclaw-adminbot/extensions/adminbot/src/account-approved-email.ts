...
export function buildAccountApprovedEmailBody(params: {
  ...
  return [
    ...
    params.dashboardUrl,
    "",
    "Once you are in, the dashboard shows the lab roster, active papers and their deadlines, and the reimbursement tool. Your onboarding checklist is waiting on the welcome screen.",
    "",
