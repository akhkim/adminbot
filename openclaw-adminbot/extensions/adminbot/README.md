...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| `content/deadlines/`         | The deadline dataset and board template (`venues.json`, `neurips2026-workshops.json`, `dm-templates.json`, `deadlines-board.html`), refreshed by `scripts/adminbot-deadline-*.py`. Read by Python and shell as well as by TypeScript. | `src/workflows/deadlines/`  |
