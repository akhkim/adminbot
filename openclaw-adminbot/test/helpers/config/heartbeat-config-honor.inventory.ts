...
export const HEARTBEAT_CONFIG_HONOR_INVENTORY: ConfigHonorInventoryRow[] = [
  {
    ...
    typePaths: ["src/config/types/agent-defaults.ts", "src/config/zod/agent-runtime.ts"],
    mergePaths: ["src/infra/heartbeat/heartbeat-runner.ts", "src/agents/acp/acp-spawn.ts"],
    consumerPaths: ["src/infra/heartbeat/heartbeat-runner.ts", "src/agents/acp/acp-spawn.ts"],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: [
      "src/infra/heartbeat/heartbeat-runner.returns-default-unset.test.ts",
  ...
  },
  {
    ...
    typePaths: ["src/config/types/agent-defaults.ts", "src/config/zod/agent-runtime.ts"],
    mergePaths: ["src/infra/heartbeat/heartbeat-runner.ts"],
    consumerPaths: ["src/infra/heartbeat/heartbeat-runner.ts"],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: [
      "src/infra/heartbeat/heartbeat-runner.model-override.test.ts",
      "src/gateway/config-reload.test.ts",
    ],
  },
  {
    ...
    consumerPaths: ["src/infra/heartbeat/heartbeat-runner.ts"],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: ["src/infra/heartbeat/heartbeat-runner.returns-default-unset.test.ts"],
  },
  {
    ...
    typePaths: ["src/config/types/agent-defaults.ts", "src/config/zod/agent-runtime.ts"],
    mergePaths: ["src/agents/prompt/heartbeat-system-prompt.ts"],
    consumerPaths: [
      "src/agents/prompt/heartbeat-system-prompt.ts",
      "src/agents/embedded-agent-runner/run/attempt.prompt-helpers.ts",
    ],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: ["src/agents/prompt/heartbeat-system-prompt.test.ts"],
  },
  {
    key: "ackMaxChars",
    ...
    consumerPaths: ["src/infra/heartbeat/heartbeat-runner.ts"],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: ["src/infra/heartbeat/heartbeat-runner.respects-ackmaxchars-heartbeat-acks.test.ts"],
  },
  {
    ...
    consumerPaths: ["src/infra/heartbeat/heartbeat-runner.ts"],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: ["src/infra/heartbeat/heartbeat-runner.model-override.test.ts"],
  },
  {
    key: "timeoutSeconds",
    schemaPaths: [
    ...
    mergePaths: ["src/infra/heartbeat/heartbeat-runner.ts"],
    consumerPaths: [
      "src/infra/heartbeat/heartbeat-runner.ts",
      "src/auto-reply/reply/get-reply/get-reply.ts",
    ],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: [
      "src/config/zod/agent-defaults.test.ts",
      "src/infra/heartbeat/heartbeat-runner.model-override.test.ts",
    ],
  },
  {
    ...
    consumerPaths: [
      "src/infra/heartbeat/heartbeat-runner.ts",
      "src/agents/prompt/bootstrap-files.ts",
    ],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: [
      "src/infra/heartbeat/heartbeat-runner.model-override.test.ts",
      "src/agents/prompt/bootstrap-files.test.ts",
      "src/gateway/config-reload.test.ts",
    ],
  },
  {
  ...
  },
  {
    ...
    typePaths: ["src/config/types/agent-defaults.ts", "src/config/zod/agent-runtime.ts"],
    mergePaths: ["src/infra/heartbeat/heartbeat-runner.ts", "src/infra/outbound/targets.ts"],
    consumerPaths: ["src/infra/outbound/targets.ts", "src/infra/heartbeat/heartbeat-runner.ts"],
    reloadPaths: ["src/gateway/config-reload-plan.ts"],
    testPaths: [
      "src/infra/heartbeat/heartbeat-runner.returns-default-unset.test.ts",
  ...
  },
  {
    ...
    testPaths: [
      "src/infra/heartbeat/heartbeat-runner.returns-default-unset.test.ts",
      "src/infra/heartbeat/heartbeat-runner.respects-ackmaxchars-heartbeat-acks.test.ts",
    ],
  },
  {
    key: "directPolicy",
