...
export type MemberRosterEntry = Schemas["AdminBot.Contracts.Workflows.Members.MemberRosterEntry"];
export type MemberRosterProjection = Schemas["AdminBot.Contracts.Workflows.Members.MemberRosterProjection"];
export type UpdateOwnMemberProfileInput = Schemas["AdminBot.Contracts.Workflows.Members.UpdateOwnMemberProfileInput"];
export type UpdateMemberGovernanceInput = Schemas["AdminBot.Contracts.Workflows.Members.UpdateMemberGovernanceInput"];
export type ReplaceMemberRolesInput = Schemas["AdminBot.Contracts.Workflows.Members.ReplaceMemberRolesInput"];
export type ReplaceMemberVisibilityInput = Schemas["AdminBot.Contracts.Workflows.Members.ReplaceMemberVisibilityInput"];
